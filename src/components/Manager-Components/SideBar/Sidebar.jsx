                ...
                <div className="space-y-6 px-4 py-6">
                    <ul className="space-y-8">
                        ...
                        >
                            ...
                            <a href="/dashboard/manager" className="flex-1">
                                الصفحة الرئيسية
                            </a>
                        </li>

                        <li
                            className={`p-3 flex items-center gap-2 text-sm rounded-lg hover:bg-indigo-600 transition ${isActiveTab('mytasks') ? 'bg-indigo-700' : ''}`}
                        >
                            <FaTasks className="text-xl mr-4" />
                            <a href="/dashboard/manager/mytasks" className="flex-1">مهامي</a>
                        </li>
                        ...
                        >
                            ...
                            <a href="/dashboard/manager/myaccount" className="flex-1">إعدادات الحساب</a>
                        </li>
                    </ul>
