                        ...
                        >
                            ...
                            <div className="p-6">
                                <div className="flex items-center gap-x-4 text-xs">
                                    <time dateTime={resource.created_at} className="text-gray-500">
                                ...
                                <div className="group relative mt-3">
                                    ...
                                    <p className="mt-5 line-clamp-3 text-sm/6 text-gray-600">{resource.sub_description}</p>
                                </div>
                                <div className="relative mt-8 flex items-center gap-x-4">
                                    <img alt="" src={resource.author_image} className="h-10 w-10 rounded-full bg-gray-50" />
