...
export default function Page() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`${Api_Uri}/services/create`, serviceData, {
            ...
            if (err.response.status === 401) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'حدث خطأ أثناء إنشاء الخدمة',
    ...
    return (
        <SideBar currentTab={"service"}>
            <div className="md:bg-gray-50 md:p-8 rounded-lg md:shadow-sm sm:p-0 sm:bg-white">
                <h2 className="text-4xl font-semibold text-center mb-8 text-indigo-600">إنشاء خدمة جديدة</h2>
